 ...
 * fileName : NftTransactionHistoryResponseDTO
 * author :  ljs7756
 * date : 2022-12-26
 * description :
 * ===========================================================
...
@Getter
@Setter
public class NftTransactionHistoryResponseDTO {
    ...
    private String nftitmCntntsThumbFileId;
    ...
    @Schema(example = "TRANSFER", allowableValues = {"trade", "transfer", "minting"}, description = "거래 타입")
